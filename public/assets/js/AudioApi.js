...
//     if (
//       allTrackList[lastLoadMusic].state_track == "ON_ERROR" ||
//       allTrackList[lastLoadMusic].state_track == "TOO_LONG"
//     ) {
//       lastLoadMusic++;
//     }
//   }
...
//       reset = true;
//     }
//     promiseList[lastLoadMusic] = callMusic(
//       allTrackList[lastLoadMusic].download_path
//     );
//     await callMusicBlob(
//       promiseList[lastLoadMusic],
//       allTrackList[lastLoadMusic]
//     );
//     lastLoadMusic++;
//   } else {
//     promiseList[lastLoadMusic] = callMusic(
...
//       if (
//         typeof musicList[0] !== "undefined" &&
//         typeof allTrackList[0].thumbnail_path !== "undefined"
//       ) {
...
//     if (
//       allTrackList[last].order > musicList[i].number &&
//       currentMusicPlaying.loop !== musicList[i].loop
//     ) {
...
export class AudioApi {
  ...
  static getInstance() {
    if (!AudioApi.instance) {
      AudioApi.instance = new AudioApi();
    }
    return AudioApi.instance;
  }

  async init() {
    // set the workflow here
    //new Player();

    const trackList = new TrackList(Utils.decodeUrl());
    await trackList.callTrackList();
